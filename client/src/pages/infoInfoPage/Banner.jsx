...
const Banner = () => {
  ...
  const dropdownOptions = [
    { text: "最新活動", href: "/infoEventPage", value: "latestActivity" },
    {
      text: "樂園須知",
      href: "#infoPage",
      value: "parkInfo",
    ...
    {
      text: "活動時間",
      href: "/infoEventPage#todayActivities",
      value: "timeTable",
    },
    {
      text: "注意事項",
      href: "/infoEventPage#activityNotes",
      value: "parkSuggestions",
    },
  ];
      ...
      <div className="bannerContent">
        ...
        <div className="bannerMenu">
          ...
          <div className="bannerItemGroup">
            ...
            <a href="#infoPage" className="menuItem">
